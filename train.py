...
class Train:
    def __init__(self,root):
        ...
        title_lbl=Label(self.root,text="Train data set",font=("times new roman",35,"bold"),bg="lightblue",fg="white")
        title_lbl.place(x=0,y=0,width=1530,height=45)

        #  //plz add images and location
        img_top=Image.open(r"C:\Users\Hp\Desktop\facerec2\college images\facedetector.jpg")
        ...
        b1_1.place(x=0,y=600,width=1530,height=60)

       # img_bottom=Image.open(r"C:\Users\Hp\Desktop\facerec2\college images\traindata2.jpeg")
