...
class Attendance:
    def __init__(self,root):
        ...
        img=Image.open(r"college images\sies.jpg")
        ...
        img1=Image.open(r"C:\Users\Hp\Desktop\facerec2\college images\students-in-classroom.jpg")
        ...
        img3=Image.open(r"C:\Users\Hp\Desktop\facerec2\college images\sies.jpg")
        ...
        img_left=Image.open(r"college images\students-in-classroom.jpg")
    ...
    def exportCsv(self):
        try:
            ...
            with open(fln,mode="w",newline="") as myfile:
                ...
                messagebox.  showinfo("Data Expoert","Your data expoted to"+os.path.basename(fln)+"successfully")
